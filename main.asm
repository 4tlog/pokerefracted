...
INCLUDE "gfx/fishing.asm"               ; moved from bank1E
INCLUDE "engine/movie/evolution.asm"    ; moved from bank1E
...
;INCLUDE "gfx/fishing.asm"                    ; moved to Itemfinder 2
