...
;FossilKabutopsPic::   INCBIN "gfx/pokemon/front/fossilkabutops.pic"    ;pics 7
...
;FossilAerodactylPic::  INCBIN "gfx/pokemon/front/fossilaerodactyl.pic"   ;pics 7
;GhostPic::             INCBIN "gfx/battle/ghost.pic"                     ;pics 7
