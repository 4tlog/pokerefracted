KeyItemFlags:
	...
	dbit FALSE ; FIGHT_STONE
	dbit FALSE ; POISN_STONE
	dbit FALSE ; GROUN_STONE
	dbit FALSE ; FLY_STONE	
	dbit FALSE ; PSYCH_STONE
	dbit FALSE ; BUG_STONE	
	dbit FALSE ; ROCK_STONE
	dbit FALSE ; GHOST_STONE
	dbit FALSE ; DRAG_STONE
