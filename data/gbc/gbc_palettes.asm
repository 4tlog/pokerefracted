...
ENDC
	...
	RGB 31,31,31, 00,18,30, 00,00,26, 03,03,03 ; PAL_BLUEICON
	RGB 31,31,31, 26,13,31, 14,13,30, 09,05,11 ; PAL_PURPICON
	RGB 31,31,31, 31,11,00, 17,09,05, 10,06,03 ; PAL_BROWNICON
	RGB 31,31,31, 16,16,16, 27,24,00, 05,15,00 ; PAL_BUGICON	
