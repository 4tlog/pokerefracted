PokedexEntryPointers:
	...
	dw GhMarowakDexEntry
	dw IceSandshrewDexEntry
	dw IceSandslashDexEntry
	dw IceVulpixDexEntry
	dw IceNinetaleDexEntry
	dw PsyPonytaDexEntry
	dw PsyRapidashDexEntry
	dw NarcticDexEntry
